...
void FRGameplayTags::InitializeNativeGameplayTags()
{
	...
	//Navigation
	GameplayTags.NavigatorTypes_Compass = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("navigation.compass"), FString("Compass"));
	GameplayTags.NavigatorTypes_Minimap = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("navigation.minimap"), FString("Minimap"));
	GameplayTags.NavigatorTypes_Worldmap = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("navigation.worldmap"), FString("World Map"));
