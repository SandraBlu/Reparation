...
void UAODamageAbility::CauseDamage(AActor* TargetActor)
{
...
FTaggedMontage UAODamageAbility::GetRandomTaggedMontage(const TArray<FTaggedMontage>& TaggedMontages) const
{
