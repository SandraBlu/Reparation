...
UCLASS( ClassGroup=(Custom), DisplayName = "Navigation Component", meta=(BlueprintSpawnableComponent) )
class REPARATION_API UNavigationComponent : public UActorComponent
{
	GENERATED_BODY()
